...
export default function MyProfile() {
  ...
  return (
    <div className="min-h-screen bg-orange-50 flex flex-col md:flex-row p-6 gap-6">
      {/* Side Panel */}
      <aside className="md:w-1/4 w-full bg-white rounded-xl shadow-md p-4 text-center">
        <img
        ...
        <button className="mt-6 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-full text-sm">
          Edit Profile
        </button>
      </aside>
      ...
      <main className="flex-1 space-y-6">
        ...
        <section className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="flex gap-4 mb-4">
            <button
              className={`flex items-center gap-2 px-3 py-1 rounded-full text-sm ${
                activeTab === 'preferences' ? 'bg-orange-500 text-white' : 'bg-zinc-100'
              }`}
            ...
            <button
              className={`flex items-center gap-2 px-3 py-1 rounded-full text-sm ${
                activeTab === 'allergies' ? 'bg-orange-500 text-white' : 'bg-zinc-100'
              }`}
            ...
            <button
              className={`flex items-center gap-2 px-3 py-1 rounded-full text-sm ${
                activeTab === 'intolerances' ? 'bg-orange-500 text-white' : 'bg-zinc-100'
              }`}
          ...
          {/* Tab Content */}
          <div className="text-sm bg-zinc-50 p-4 rounded-lg">
          ...
          <button className="mt-4 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-full text-sm">
            Update Preferences
          </button>
        </section>
        ...
        <section className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
              <p className="text-sm">You're currently on the <strong className="text-orange-500">Free Plan</strong>.</p>
              <ul className="text-xs text-zinc-600 mt-2 list-disc ml-4">
